 ...
 * Measures timeline construction and lookup performance at a realistic HTTP
 * request scale (5 000 rows).
 *
 ...
 * manually in the browser.  These benchmarks establish a baseline so that
 * future changes can be confirmed not to have introduced JS-side regressions.
 *
 ...
 *
 * @example generateDenseTimeData(5000) → 5000 entries, 1 s apart
 */
 ...
 *
 * @example generateSparseTimeData(5000) → 500 bursts × 10 requests, 30 s gaps
 */
...
// ---------------------------------------------------------------------------
// Pre-computed fixtures (build once, look up many times)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Benchmarks: buildCompressedTimeline
// ---------------------------------------------------------------------------
